...
class PGDFairnessTrainer(BaseCertifierModel):
    ...
    def training_step(self, batch, batch_idx):
        ...
        regval = 0.0
        if self.ALPHA > 0:
            regval = FairCertModule.fairness_regularizer_PGD(self, x, y, self.fair_interval, self.eps, nclasses=self.num_classes)
    ...
    def validation_step(self, batch, batch_idx):
        ...
        if self.ALPHA > 0:
            regval = FairCertModule.fairness_regularizer_PGD(self, x, y, self.fair_interval, self.EPSILON,
